<?php
    ...
    headerTop('../images/header/281985.jpg','"Viver é enfrentar um problema atrás do outro.<br> O modo como você o encara é que faz a diferença."','Benjamin Franklin');
?>
...
<section class="pt5 backgroundSectionYellow" id="1">
    <div class="row">
        ...
        <div class="xl-6 tab-12 column">
            <figure>
                <img src="../images/2149589100.jpg" srcset="../images/2149589100.jpg 1000w, ../images/2149589100.jpg 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
            </figure>
        </div>
    </div> 
</section>
...
<section class="pt5 backgroundSectionYellow" id="2">
    <div class="row">
        <div class="xl-6 tab-12 column">
            <figure class="flexFigure">
                <img  class="flexImage" src="../images/37542.jpg" srcset="../images/37542.jpg 1000w, ../images/37542.jpg 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
            </figure>
        </div>
...
<div class="row">
    <div class="xl-6 tab-12 column">
            <figure>
                <img src="../images/2150844829.jpg" srcset="../images/2150844829.jpg 1000w, ../images/2150844829.jpg 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
            </figure>
        </div>
        <div class="xl-6 tab-12 column">
