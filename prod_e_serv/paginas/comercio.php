<?php
    ...
    headerTop('../images/header/2148164688.jpg','" Ciclo Eterno: nascem da terra, transformam-se pelo<br> trabalho humano e retornam ao mundo, sustentando a jornada da humanidade. "','');
...
<!-- <li class=" white-text ">E por fim, para custear a manutenção da nossa estrutura e investir em projetos sociais que partilhem do mesmo propósito , de forma direta ou indireta, ao <b class="white-text">INSTITUTO</b>, no Brasil e no Exterior.
        ...
        <div class="xl-6 tab-12 column" >
            <figure class="flexFigure">
                <img class="flexImage" src="../images/275.jpg" srcset="../images/275.jpg 1000w, ../images/275.jpg 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
            </figure>
        </div>        
    </div>
</section>
