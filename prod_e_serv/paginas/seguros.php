<?php
    ...
    headerTop('../images/header/1374.jpg','" O plano mais seguro é não depender da sorte. "','Napoleon Hill');
...
A segurança é o princípio fundamental que orienta todas as nossas ações. Por isso, criamos soluções personalizadas e acessíveis, promovendo a saúde, o bem-estar e a tranquilidade de nossos clientes.
        ...
        <div class="xl-6 tab-12 column" >
            <figure class="flexFigure">
                <img class="flexImage" src="../images/s04_1671021302.webp" srcset="../images/s04_1671021302.webp 1000w, ../images/s04_1671021302.webp 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
            </figure>
        </div>        
    </div>
</section>
