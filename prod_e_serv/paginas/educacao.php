<?php
    ...
    headerTop('../images/header/2646.jpg','" É no problema da educação, que assenta o grande <br>segredo do aperfeiçoamento da humanidade."','Immanuel Kant');
...
Acreditamos que conhecimento é poder. Utilizamos nosso saber para combater as desigualdades, erradicar a pobreza, alcançar a Fome Zero e garantir o acesso universal à água potável e ao saneamento.<br><br>
        ...
        <div class="xl-6 tab-12 column" >
            <figure class="flexFigure">
                <img class="flexImage" src="../images/cc03_1670907093.webp" srcset="../images/cc03_1670907093.webp 1000w, ../images/cc03_1670907093.webp 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
            </figure>
        </div>        </div>
    </section>
...
<p>
"Não é uma aspiração fácil, mas se começarmos a girar a chave,
abriremos as portas de transformação para nossa sociedade."
</p>
