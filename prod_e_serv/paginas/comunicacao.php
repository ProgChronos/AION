<?php
    ...
    headerTop('../images/header/1791.jpg','
"Acredito firmemente que qualquer ferramenta,<br>

 que aprimore a comunicação, tem efeitos profundos em termos<br> de como as pessoas podem aprender umas com as outras<br>

 e como podem alcançar o tipo de liberdade que querem."','Bill Gates');
...
<section class="backgroundSectionWhite " id="6">

<div class="row row-x-center">
<div class="column xl-6 md-12 ">

<h3 class="h-add-bottom ">Eu Aion</h3>
    ...
    <div class="row">
        ...
        <div class="xl-6 tab-12 column" >
            <figure class="flexFigure">
                <img class="flexImage" src="../images/cmc003_1670986246.webp" srcset="../images/cmc003_1670986246.webp 1000w, ../images/cmc003_1670986246.webp 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
            </figure>
        </div>        
    </div>
</section>
