<?php
    ...
    headerTop('images/header/pessoasHeader.jpg','“O TEMPO é a moeda mais preciosa que temos, cujo o valor não podemos exprimir.”','Equipe Aion');
...
<section class="backgroundSectionYellow " id="1">
    <div class="row">
        ...
        <div class="xl-6 tab-12 column" > 
            <p class="lead" >
                <b>Empregar seus recursos no tempo é uma medida de sustentabilidade cultural.</b><br><br>
                Por sustentabilidade cultural, entende-se o conceito atribuído ao economista e sociólogo polonês Sanchs (2004), sobre o respeito a valorização da tradição e o a emergência da inovação. A sustentabilidade cultural é a inserção dos valores culturais às pessoas, incorporando a sustentabilidade na estratégia.
            </p>
        </div>
    </div> 
</section>
...
<section class="backgroundSectionBlack " id="2">
    <div class="row">
        <div class="xl-6 tab-12 column" > 
            <p class="lead white-text" >
            Ao investir nestas práticas, estar a se realizar uma imensa contribuição para a evolução e aprimoramento do indivíduo, e uma vez que as pessoas ganham acesso a novas informações e recursos, elas possuem maior liberdade de expressão e podem desenvolver novas ideias e pensamentos de forma ecologicamente correta. Giddens (2001) afirma que <mark>"sem o aspecto cultural, não seriamos humanos"</mark> e Freud (1930), reforça isto, ao evidenciar que <mark>"aquisição cultural é a principal ferramenta de evolução da humanidade."</mark> A sustentabilidade cultural é esse movimento de uma sociedade na qual todos se engajam, para juntos promover um mundo melhor.
            </p>
        </div>
...
<section class="backgroundSectionYellow " id="3">
    <div class="row">
        <div class="xl-6 tab-12 column" > 
            <h2>Prosperidade</h2>
