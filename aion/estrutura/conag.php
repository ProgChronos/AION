<?php
    ...
    headerTop('images/6709.jpg','" EU ESTRUTURO<br>
EU SOMO<br>
EU MULTIPLICO"','Conag');
...
<section class="backgroundSectionYellow " id="1">
    <div class="row">
        <div class="xl-6 tab-12 column" style="align-items: center; display: flex;" >
            <a href="images/conag0003_1671027484.webp" data-fancybox data-caption="">
                <img src="images/conag0003_1671027484.webp"  srcset="images/conag0003_1671027484.webp 1000w, images/conag0003_1671027484.webp 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
            </a>
        </div>
...
<br><br>
        ...
        <div class="xl-6 tab-12 column" >
            <figure class="flexFigure">
                <a href="images/97.jpg" data-fancybox data-caption="">
                    <img class="flexImage" src="images/97.jpg" srcset="images/97.jpg 1000w, images/97.jpg 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
                </a>
            </figure>
        </div>        
    </div>
...
<section class="backgroundSectionYellow " id="1">
    <div class="row">
        <div class="xl-6 tab-12 column" style="align-items: center; display: flex;" >
            <figure class="flexFigure"> 
                <a href="images/769.jpg" data-fancybox data-caption="">
                    <img class="flexImage" src="images/769.jpg"  srcset="images/769.jpg 1000w, images/769.jpg 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
                </a>
            </figure>
        </div>
        <div class="xl-6 tab-12 column" > 
