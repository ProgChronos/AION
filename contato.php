...
<div class="row width-narrower pagemain">
         ...
         <h2 class="text-display-title">Vamos para um novo passo a sua empresa...</h2>
             ...
             <div class="row">
                 ...
                 <a href="aion/instituto/images/aionbrasao.png" data-fancybox data-caption="">
                    <img  class="sombraCinza" src="aion/instituto/images/aionbrasao.png" srcset="aion/instituto/images/aionbrasao.png 1000w, aion/instituto/images/aionbrasao.png 500w" sizes="(max-width: 1000px) 100vw, 1000px" alt="">
                </a>
                     
                 </div> 
                 <div class="column xl-6 md-12 contact-cta">     
                 <p>
                 Agora é o momento de olhar para frente e avançar com estratégias sólidas, inovação e foco nos resultados. Neste estágio, é essencial definir os próximos objetivos e alinhar todos os esforços para alcançá-los de forma eficiente.<br><br>
                 É hora de consolidar a sua presença no mercado, fortalecer a identidade da marca e criar uma conexão ainda mais forte com seus clientes. Com uma visão clara de onde queremos chegar, cada decisão será orientada para o crescimento sustentável e o sucesso contínuo.
                     </p>
